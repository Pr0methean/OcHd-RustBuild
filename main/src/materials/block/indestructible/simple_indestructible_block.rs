...
block_with_colors!(
    BEDROCK = ComparableColor::STONE_EXTREME_SHADOW,
...
single_texture_block!(
    END_PORTAL_FRAME_SIDE = ComparableColor::TRANSPARENT,
    END_STONE.material.texture(),
    paint_svg_task("endPortalFrameSide", c(0x26002a))
);

single_texture_block!(
    END_PORTAL_FRAME_TOP = ComparableColor::TRANSPARENT,
    END_STONE.material.texture(),
...
group!(
    SIMPLE_INDESTRUCTIBLE_BLOCKS = BEDROCK,
