...
pub struct Wood {
    ...
    pub bark_color: ComparableColor,
    pub bark_highlight: ComparableColor,
    pub bark_shadow: ComparableColor,
    pub leaves_color: ComparableColor,
    pub leaves_highlight: ComparableColor,
    pub leaves_shadow: ComparableColor,
