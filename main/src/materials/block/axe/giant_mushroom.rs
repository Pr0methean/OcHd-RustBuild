...
single_texture_block!(
    RED_MUSHROOM_BLOCK = RED_MUSHROOM_BACKGROUND,
    paint_stack!(
...
single_texture_block!(
    BROWN_MUSHROOM_BLOCK = BROWN_MUSHROOM_BACKGROUND,
    paint_svg_task("rings", c(0x9d825e))
);
single_texture_block!(
    MUSHROOM_STEM = c(0xd0d0c4),
    paint_stack!(MUSHROOM_STEM_MAIN_COLOR, "railTies", "borderShortDashes")
);
single_texture_block!(
    MUSHROOM_BLOCK_INSIDE = c(0xD7C187),
    paint_stack!(
        c(0xab9066),
        "bigDotsTopLeftBottomRight",
        "dots0",
...
group!(
    GIANT_MUSHROOM = RED_MUSHROOM_BLOCK,
