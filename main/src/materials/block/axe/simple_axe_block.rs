...
use crate::materials::block::axe::wood::{BIRCH, DARK_OAK, OAK, OAK_COLOR, SPRUCE};
...
single_texture_block!(
    CRAFTING_TABLE_SIDE = ComparableColor::TRANSPARENT,
    stack_on!(
        OAK.color,
