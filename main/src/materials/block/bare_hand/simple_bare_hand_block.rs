...
use crate::materials::block::axe::giant_mushroom::{BROWN_MUSHROOM_BACKGROUND, MUSHROOM_STEM_MAIN_COLOR, RED_MUSHROOM_BACKGROUND};
block_with_colors!(SUGARCANE = c(0xaadb74), c(0x82a859), c(0x91ff32),
...
single_texture_block!(BROWN_MUSHROOM = ComparableColor::TRANSPARENT,
    paint_svg_task("mushroomStem", MUSHROOM_STEM_MAIN_COLOR),
    paint_svg_task("mushroomCapBrown", BROWN_MUSHROOM_BACKGROUND)
);

single_texture_block!(RED_MUSHROOM = ComparableColor::TRANSPARENT,
    paint_svg_task("mushroomStem", MUSHROOM_STEM_MAIN_COLOR),
...
single_layer_block!(TWISTING_VINES = "zigzagSolidBottomPart", TWISTING_VINE_COLOR);
...
single_texture_block!(HONEYCOMB_BLOCK = HONEYCOMB_CELLS,
    paint_svg_task("honeycomb", HONEYCOMB_BORDER)
);

group!(SIMPLE_BARE_HAND_BLOCKS = SUGARCANE, BROWN_MUSHROOM, RED_MUSHROOM, REDSTONE_DUST_DOT,
        REDSTONE_DUST_LINE0, REDSTONE_DUST_LINE1, TWISTING_VINES_PLANT, TWISTING_VINES,
        WEEPING_VINES_PLANT, WEEPING_VINES, HONEYCOMB_BLOCK);
