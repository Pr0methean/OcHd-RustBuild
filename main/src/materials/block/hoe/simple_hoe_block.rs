...
block_with_colors!(SHROOMLIGHT = c(0xffac6d), c(0xd75100), c(0xffffb4),
    color!(),
...
block_with_colors!(TARGET_SIDE = c(0xffd7ba), REDSTONE.colors.shadow, ComparableColor::WHITE,
    color!(),
    paint_svg_task("grassTall", highlight!()),
    paint_svg_task("ringsCentralBullseye", shadow!())
);

block_with_colors!(TARGET_TOP = c(0xffd7ba), REDSTONE.colors.shadow, ComparableColor::WHITE,
    color!(),
