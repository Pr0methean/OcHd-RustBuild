...
static STAINED_GLASS_BASE: Lazy<ToAlphaChannelTaskSpec> = Lazy::new(|| ToAlphaChannelTaskSpec::StackAlphaOnBackground {
        background: 0x40,
...
group!(GLASS_VARIANTS = GLASS_PANE_TOP, GLASS, TINTED_GLASS, STAINED_GLASS, STAINED_GLASS_PANE_TOP);
