...
use crate::image_tasks::task_spec::{
    from_svg_task, paint_svg_task, paint_task, stack_alpha, svg_alpha_task, ToPixmapTaskSpec,
};
use crate::materials::block::pickaxe::ore::{COPPER, QUARTZ};
use crate::materials::block::pickaxe::ore_base::DEEPSLATE;
use crate::materials::block::pickaxe::polishable::BLACKSTONE;
use crate::materials::block::shovel::simple_soft_earth::{
    MOSS_BLOCK, MUD, PACKED_MUD, RED_SAND, SAND,
};
use crate::texture_base::material::{SingleTextureMaterial, TricolorMaterial};
use crate::{
    block_with_colors, group, make_tricolor_block_macro, paint_stack, single_texture_block,
    stack_alpha, stack_on,
};
use once_cell::sync::Lazy;

single_texture_block!(
    DEEPSLATE_BRICKS = ComparableColor::TRANSPARENT,
...
single_texture_block!(
    DEEPSLATE_TOP = ComparableColor::TRANSPARENT,
    DEEPSLATE.material.texture(),
...
static COBBLESTONE_BASE: Lazy<ToPixmapTaskSpec> = Lazy::new(|| {
    stack_on!(
...
stone!(
    COBBLESTONE = ComparableColor::TRANSPARENT,
...
single_texture_block!(
    MOSSY_COBBLESTONE = ComparableColor::TRANSPARENT,
    COBBLESTONE_BASE.to_owned(),
...
single_texture_block!(
    COBBLED_DEEPSLATE = DEEPSLATE.shadow(),
...
sandstone!(
    CHISELED_SANDSTONE = ComparableColor::TRANSPARENT,
    CUT_SANDSTONE.material.texture(),
    paint_svg_task("creeperFaceSmall", shadow!())
);

static RED_SANDSTONE_BASE: Lazy<ToPixmapTaskSpec> = Lazy::new(|| {
    stack_on!(
        RED_SAND.color(),
...
red_sandstone!(
    RED_SANDSTONE_BOTTOM = ComparableColor::TRANSPARENT,
    RED_SANDSTONE_BASE.to_owned(),
    paint_svg_task("borderLongDashes", color!())
);

red_sandstone!(
    RED_SANDSTONE_TOP = ComparableColor::TRANSPARENT,
    RED_SANDSTONE_BASE.to_owned(),
...
red_sandstone!(
    CHISELED_RED_SANDSTONE = ComparableColor::TRANSPARENT,
...
stone!(
    CRACKED_STONE_BRICKS = ComparableColor::TRANSPARENT,
    STONE_BRICKS.material.texture(),
    paint_svg_task("streaks", extreme_shadow!())
);

stone!(
    MOSSY_STONE_BRICKS = color!(),
    paint_svg_task("checksLarge", highlight!()),
    paint_svg_task("bricks", extreme_shadow!()),
...
block_with_colors!(
    POLISHED_BLACKSTONE_BRICKS = BLACKSTONE.color(),
    BLACKSTONE.shadow(),
...
amethyst!(
    MEDIUM_AMETHYST_BUD = ComparableColor::TRANSPARENT,
...
amethyst!(
    SMALL_AMETHYST_BUD = ComparableColor::TRANSPARENT,
...
block_with_colors!(
    CUT_COPPER = COPPER.refined_colors.color,
    COPPER.refined_colors.shadow,
    COPPER.refined_colors.highlight,
    color!(),
    paint_svg_task("streaks", highlight!()),
...
block_with_colors!(
    BLACK_GLAZED_TERRACOTTA = c(0x2f2f2f),
    ComparableColor::BLACK,
    c(0x992222),
    shadow!(),
...
block_with_colors!(
    BLUE_GLAZED_TERRACOTTA = c(0x4040aa),
    c(0x2d2d8f),
    c(0x4577d3),
    shadow!(),
...
block_with_colors!(
    PURPLE_GLAZED_TERRACOTTA = c(0x8900b8),
    c(0x5f0093),
    c(0xa254e0),
    color!(),
    paint_stack!(
        shadow!(),
        "asymmetricalQuarterCircles",
    ...
    paint_stack!(
        highlight!(),
        "cornerRingTopLeft",
        "strokeTopLeftBottomRight2"
    )
);

block_with_colors!(
    BROWN_GLAZED_TERRACOTTA = c(0x8c5a35),
    c(0x007788),
    c(0xcd917c),
    color!(),
...
block_with_colors!(
    GRAY_GLAZED_TERRACOTTA = c(0x737373),
    c(0x333333),
    c(0x999999),
    color!(),
...
block_with_colors!(
    GREEN_GLAZED_TERRACOTTA = c(0x729b24),
    c(0x495b24),
    c(0xd6d6d6),
    color!(),
...
block_with_colors!(
    RED_GLAZED_TERRACOTTA = c(0xb82b2b),
    c(0x8e2020),
    c(0xce4848),
    color!(),
...
block_with_colors!(
    PINK_GLAZED_TERRACOTTA = c(0xff8baa),
    c(0xd6658f),
    c(0xffb5cb),
    shadow!(),
...
block_with_colors!(
    MAGENTA_GLAZED_TERRACOTTA = c(0xdc68dc),
    c(0xae33ae),
    c(0xffa5bf),
    shadow!(),
    paint_svg_task("stripesVerticalThick", color!()),
...
block_with_colors!(
    CYAN_GLAZED_TERRACOTTA = c(0x828282),
    c(0x333333),
    c(0x009c9c),
    color!(),
...
block_with_colors!(
    LIGHT_BLUE_GLAZED_TERRACOTTA = c(0x2389c7),
    c(0x2d2d8f),
    c(0x57bddf),
...
block_with_colors!(
    LIME_GLAZED_TERRACOTTA = c(0x8bd922),
    c(0x5ea900),
    c(0xffffc4),
    color!(),
...
block_with_colors!(
    LIGHT_GRAY_GLAZED_TERRACOTTA = ComparableColor::STONE_SHADOW,
    c(0x009c9c),
    ComparableColor::LIGHTEST_GRAY,
    color!(),
...
block_with_colors!(
    YELLOW_GLAZED_TERRACOTTA = c(0xffb000),
    c(0xa4764c),
    c(0xffff9d),
    color!(),
    paint_svg_task("cornersRound", shadow!()),
...
block_with_colors!(
    ORANGE_GLAZED_TERRACOTTA = c(0xff8000),
    c(0x009c9c),
    c(0x00c6c6),
    highlight!(),
    ...
    paint_stack!(
        shadow!(),
        "cornerTwoLobesSolidTopLeft",
        "cornerRoundBottomLeft",
        "cornerRoundBottomRight"
    ),
    paint_stack!(
        color!(),
        "cornerRingBottomRight",
        "cornerTwoLobesCutoutTopLeft"
    )
);
block_with_colors!(
    WHITE_GLAZED_TERRACOTTA = c(0x3ab3da),
    c(0x2389c7),
    c(0xffd83d),
...
group!(
    DEEPSLATE_VARIANTS = DEEPSLATE_BRICKS,
    DEEPSLATE_TOP,
    COBBLED_DEEPSLATE
);
group!(
    QUARTZ_VARIANTS = QUARTZ_BLOCK_TOP,
    QUARTZ_BLOCK_BOTTOM,
    QUARTZ_BLOCK_SIDE,
    QUARTZ_PILLAR,
    QUARTZ_PILLAR_TOP,
...
group!(
    SANDSTONE_VARIANTS = SANDSTONE_BOTTOM,
    SANDSTONE_TOP,
    SANDSTONE,
    CUT_SANDSTONE,
    CHISELED_SANDSTONE
...
group!(
    RED_SANDSTONE_VARIANTS = RED_SANDSTONE_BOTTOM,
    RED_SANDSTONE_TOP,
    RED_SANDSTONE,
    CUT_RED_SANDSTONE,
...
group!(
    TERRACOTTA_VARIANTS = TERRACOTTA,
...
group!(
    SIMPLE_PICKAXE_BLOCKS = DEEPSLATE_VARIANTS,
    QUARTZ_VARIANTS,
    STONE_VARIANTS,
